...
export const About = () => {
  return (
    <div>
        <div className="About  p-[10px]  flex lg:flex-row flex-col gap-[30px] justify-between mt-[50px]">
             <div className="about-images grid grid-cols-2 w-full lg:w-1/2 place-items-end justify-items-start  gap-[20px]">
              <img src={about_1} className='justify-self-end '/>
              <img src={about_2} className='justify-self-start '/>
              <img src={about_3} className='col-span-2 justify-self-center '/>
             </div>
             <div className="about-data lg:w-1/2 flex flex-col justify-center">
              ...
              <h2 className='bg-gradient-to-r from-purple-500 via-green-400 to-green-500 bg-clip-text text-transparent text-[32px] my-[16px] font-semibold leading-tight'>Achieving Academic Excellence Study Abroad</h2>
              ...
              <div className="ourmission">
                <h3 className='bg-gradient-to-r from-purple-500 via-green-400 to-green-500 bg-clip-text text-transparent text-[20px] mb-[10px] flex gap-[20px] items-center'><span className='font-semibold text-white'><GoGoal /></span>
                Our Mission</h3>
              ...
              <div className="ourvision">
                <h3 className='bg-gradient-to-r from-purple-500 via-green-400 to-green-500 bg-clip-text text-transparent text-[20px] mb-[10px] flex items-center gap-[20px]'><span className='text-white'><FaEye /></span>
                Our Vision</h3>
